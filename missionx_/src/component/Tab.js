        ...
        <div className="wholePage">
            ...
            <div className={isOpen ? "tab-active tab" : "tab"} >
                ...
                <div style={{ padding: '4vh 0' }}>
                    <Link className='link'><div onClick={() => toggleTab(1)} className={state === 1 ? "highlightTab tabIndividual" : "tabIndividual"}><ProjectTrackerIcon /><div style={{ display: tabDescription }}>PROJECT TRACKER</div></div></Link>
                    <Link className='link'><div onClick={() => toggleTab(2)} className={state === 2 ? "highlightTab tabIndividual" : "tabIndividual"}><StudentProfileIcon /><div style={{ display: tabDescription }}>STUDENT PROFILE</div></div></Link>
                    <Link className='link'><div onClick={() => toggleTab(3)} className={state === 3 ? "highlightTab tabIndividual" : "tabIndividual"}><HelpRequestIcon /><div style={{ display: tabDescription }}>HELP REQUEST</div></div></Link>
                    <Link className='link'><div onClick={() => toggleTab(4)} className={state === 4 ? "highlightTab tabIndividual" : "tabIndividual"}><ProjectSubmissionsIcon /><div style={{ display: tabDescription }}>PROJECT SUBMISSION</div></div></Link>
                    <Link to='/projectspage' className='link'><div onClick={() => toggleTab(5)} className={state === 5 ? "highlightTab tabIndividual" : "tabIndividual"}><ProjectLibraryIcon /><div style={{ display: tabDescription }}>PROJECT LIBRARY</div></div></Link>
                </div>
